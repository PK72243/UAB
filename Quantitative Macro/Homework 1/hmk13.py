...
mod2pl = seasonal_decompose(wages.iloc[:24,2], model="multiplicative",freq=1)
mod2pl = sm.tsa.statespace.SARIMAX(wages.iloc[:24,2],
	                                order=(1, 0, 0),
	                                seasonal_order=(1, 0, 0, 12),
									enforce_stationarity=True,enforce_invertibility=True)
results2pl = mod2pl.fit()
#print(results2pl.summary().tables[1])
pred_uc2pl = pd.DataFrame(results2pl.forecast(steps=8))
...
ticks3=["2019-I","2019-VII","2020-I","2020-VI"]
ticks4=["2020-I","2020-III","2020-V","2020-VII"]
